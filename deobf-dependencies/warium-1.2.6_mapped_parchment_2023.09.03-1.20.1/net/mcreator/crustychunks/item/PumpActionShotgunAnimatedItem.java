...
public class PumpActionShotgunAnimatedItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new PumpActionShotgunAnimatedItemRenderer();
         private static final ArmPose PumpActionShotgunAnimatedPose = ArmPose.create("PumpActionShotgunAnimated", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? PumpActionShotgunAnimatedPose : ArmPose.EMPTY;
         }
