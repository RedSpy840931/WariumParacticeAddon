         ...
         if (immediatesourceentity.getPersistentData().getDouble("T") <= 20.0D) {
            ...
            while(var32.hasNext()) {
               ...
               if (entityiterator instanceof LivingEntity) {
                  ...
                  if (Math.abs(entityiterator.getX() - x) - (Math.abs((double)immediatesourceentity.level().clip(new ClipContext(immediatesourceentity.getEyePosition(1.0F), immediatesourceentity.getEyePosition(1.0F).add(immediatesourceentity.getViewVector(1.0F).scale(512.0D)), Block.COLLIDER, Fluid.ANY, immediatesourceentity)).getBlockPos().getX() - x) + 0.5D) <= 0.0D && Math.abs(entityiterator.getZ() - z) - (Math.abs((double)immediatesourceentity.level().clip(new ClipContext(immediatesourceentity.getEyePosition(1.0F), immediatesourceentity.getEyePosition(1.0F).add(immediatesourceentity.getViewVector(1.0F).scale(512.0D)), Block.COLLIDER, Fluid.ANY, immediatesourceentity)).getBlockPos().getZ() - z) + 0.5D) <= 0.0D) {
