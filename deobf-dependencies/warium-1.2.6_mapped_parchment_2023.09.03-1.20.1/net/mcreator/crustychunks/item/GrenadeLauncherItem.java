...
public class GrenadeLauncherItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new GrenadeLauncherItemRenderer();
         private static final ArmPose GrenadeLauncherPose = ArmPose.create("GrenadeLauncher", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? GrenadeLauncherPose : ArmPose.EMPTY;
         }
