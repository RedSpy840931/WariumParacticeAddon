...
public class RiflerEntity extends Monster implements GeoEntity {
   ...
   public RiflerEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.RIFLER.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "rifler");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(RiflerEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(RiflerEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(RiflerEntity.class, EntityDataSerializers.STRING);
   }
}
