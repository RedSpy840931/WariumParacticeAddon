...
public class WorkerEntity extends Monster implements GeoEntity {
   ...
   public WorkerEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.WORKER.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "workertexture");
   }
   ...
   protected void registerGoals() {
      super.registerGoals();
      this.goalSelector.addGoal(1, new AvoidEntityGoal(this, DecimatorEntity.class, 40.0F, 1.0D, 1.2D));
      this.goalSelector.addGoal(2, new AvoidEntityGoal(this, EradicatorEntity.class, 40.0F, 1.0D, 1.2D));
   ...
   static {
      SHOOT = SynchedEntityData.defineId(WorkerEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(WorkerEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(WorkerEntity.class, EntityDataSerializers.STRING);
   }
}
