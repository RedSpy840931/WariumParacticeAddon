...
public class AutomaticRifleItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         ...
         private static final ArmPose AutomaticRiflePose = ArmPose.create("AutomaticRifle", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? AutomaticRiflePose : ArmPose.EMPTY;
         }
