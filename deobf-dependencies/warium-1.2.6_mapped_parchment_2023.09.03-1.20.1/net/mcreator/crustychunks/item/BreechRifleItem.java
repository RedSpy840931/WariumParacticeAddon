...
public class BreechRifleItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new BreechRifleItemRenderer();
         private static final ArmPose BreechRiflePose = ArmPose.create("BreechRifle", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? BreechRiflePose : ArmPose.EMPTY;
         }
