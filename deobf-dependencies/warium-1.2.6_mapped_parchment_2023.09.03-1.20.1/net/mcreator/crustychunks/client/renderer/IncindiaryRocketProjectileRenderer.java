...
public class IncindiaryRocketProjectileRenderer extends EntityRenderer<IncindiaryRocketProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/largefirerocket.png");
   ...
   public void render(IncindiaryRocketProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
