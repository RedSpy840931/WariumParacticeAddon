      ...
      if (immediatesourceentity != null) {
         ...
         if (immediatesourceentity.getPersistentData().getDouble("T") <= 20.0D) {
            ...
            for(int index0 = 0; index0 < 256; ++index0) {
               ...
               if (!world.isEmptyBlock(new BlockPos(immediatesourceentity.level().clip(new ClipContext(immediatesourceentity.getEyePosition(1.0F), immediatesourceentity.getEyePosition(1.0F).add(immediatesourceentity.getViewVector(1.0F).scale(200.0D)), Block.COLLIDER, Fluid.ANY, immediatesourceentity)).getBlockPos().getX(), immediatesourceentity.level().clip(new ClipContext(immediatesourceentity.getEyePosition(1.0F), immediatesourceentity.getEyePosition(1.0F).add(immediatesourceentity.getViewVector(1.0F).scale(200.0D)), Block.COLLIDER, Fluid.ANY, immediatesourceentity)).getBlockPos().getY(), immediatesourceentity.level().clip(new ClipContext(immediatesourceentity.getEyePosition(1.0F), immediatesourceentity.getEyePosition(1.0F).add(immediatesourceentity.getViewVector(1.0F).scale(200.0D)), Block.COLLIDER, Fluid.ANY, immediatesourceentity)).getBlockPos().getZ())) && world instanceof Level) {
                  Level _level = (Level)world;
                  if (!_level.isClientSide()) {
                     _level.explode((Entity)null, (double)immediatesourceentity.level().clip(new ClipContext(immediatesourceentity.getEyePosition(1.0F), immediatesourceentity.getEyePosition(1.0F).add(immediatesourceentity.getViewVector(1.0F).scale(200.0D)), Block.COLLIDER, Fluid.ANY, immediatesourceentity)).getBlockPos().getX(), (double)immediatesourceentity.level().clip(new ClipContext(immediatesourceentity.getEyePosition(1.0F), immediatesourceentity.getEyePosition(1.0F).add(immediatesourceentity.getViewVector(1.0F).scale(200.0D)), Block.COLLIDER, Fluid.ANY, immediatesourceentity)).getBlockPos().getY(), (double)immediatesourceentity.level().clip(new ClipContext(immediatesourceentity.getEyePosition(1.0F), immediatesourceentity.getEyePosition(1.0F).add(immediatesourceentity.getViewVector(1.0F).scale(200.0D)), Block.COLLIDER, Fluid.ANY, immediatesourceentity)).getBlockPos().getZ(), 5.0F, ExplosionInteraction.BLOCK);
                  }
               }

               if (1 == Mth.nextInt(RandomSource.create(), 1, 3)) {
                  world.addParticle((SimpleParticleType)CrustyChunksModParticleTypes.SPACE_FIREBALL.get(), x, y, z, immediatesourceentity.getLookAngle().x * Mth.nextDouble(RandomSource.create(), -1.0D, 1.0D), immediatesourceentity.getLookAngle().y * Mth.nextDouble(RandomSource.create(), -1.0D, 1.0D), immediatesourceentity.getLookAngle().z * Mth.nextDouble(RandomSource.create(), -1.0D, 1.0D));
               }
            }

            _center = new Vec3(x, y, z);
            _entfound = world.getEntitiesOfClass(Entity.class, (new AABB(_center, _center)).inflate(40.0D), (e) -> {
               return true;
