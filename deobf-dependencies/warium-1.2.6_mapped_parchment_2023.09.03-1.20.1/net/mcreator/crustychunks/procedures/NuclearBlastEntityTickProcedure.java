   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         if (1.0D == immediatesourceentity.getPersistentData().getDouble("T")) {
            FissionEffectsProcedure.execute(world, x, immediatesourceentity.getY() - 15.0D, z);
         ...
         for(particleAmount = (double)(1L + Math.round(xRadius)); loop < particleAmount; ++loop) {
            if (immediatesourceentity.getPersistentData().getDouble("T") / 4.0D == (double)Math.round(immediatesourceentity.getPersistentData().getDouble("T") / 4.0D)) {
               Level _level;
               if (1 == Mth.nextInt(RandomSource.create(), 1, 4)) {
                  ...
                  if (300.0D >= immediatesourceentity.getPersistentData().getDouble("T")) {
                     ...
                     if (5.0D <= immediatesourceentity.getPersistentData().getDouble("T")) {
                        ...
                        world.addParticle((SimpleParticleType)CrustyChunksModParticleTypes.NUCLEAR_SHOCK_PARTICLE.get(), x + 0.5D + Math.cos(6.283185307179586D / particleAmount * loop) * xRadius, y + Mth.nextDouble(RandomSource.create(), 22.0D, 32.0D), z + 0.5D + Math.sin(6.283185307179586D / particleAmount * loop) * zRadius, Math.cos(6.283185307179586D / particleAmount * loop), 0.0D, Math.sin(6.283185307179586D / particleAmount * loop));
                        if (30.0D <= immediatesourceentity.getPersistentData().getDouble("T")) {
                           world.addParticle((SimpleParticleType)CrustyChunksModParticleTypes.NUCLEAR_SHOCK_PARTICLE.get(), x + 0.5D + Math.cos(6.283185307179586D / particleAmount * loop) * (xRadius - 30.0D), y + Mth.nextDouble(RandomSource.create(), 64.0D, 70.0D), z + 0.5D + Math.sin(6.283185307179586D / particleAmount * loop) * (zRadius - 30.0D), Math.cos(6.283185307179586D / particleAmount * loop), 0.0D, Math.sin(6.283185307179586D / particleAmount * loop));
                        }
                     }
                  }
                  ...
                  _level = (Level)world;
                  if (!_level.isClientSide()) {
                     _level.explode((Entity)null, x + 0.5D + Math.cos(6.283185307179586D / particleAmount * loop) * xRadius, (double)(world.getHeight(Types.MOTION_BLOCKING_NO_LEAVES, (int)(x + 0.5D + Math.cos(6.283185307179586D / particleAmount * loop) * xRadius), (int)(z + 0.5D + Math.sin(6.283185307179586D / particleAmount * loop) * zRadius)) + 1), z + 0.5D + Math.sin(6.283185307179586D / particleAmount * loop) * zRadius, 2.0F, ExplosionInteraction.NONE);
                  }
               }
         ...
         if (250.0D <= immediatesourceentity.getPersistentData().getDouble("T") && !immediatesourceentity.level().isClientSide()) {
