      ...
      if (immediatesourceentity != null) {
         for(int index0 = 0; index0 < 25; ++index0) {
            if (world instanceof ServerLevel) {
               ...
               _entityToSpawn.shoot(immediatesourceentity.getDeltaMovement().x(), immediatesourceentity.getDeltaMovement().y(), immediatesourceentity.getDeltaMovement().z(), 4.0F, 22.0F);
