      ...
      for(int index0 = 0; index0 < 3; ++index0) {
         ...
         for(int index1 = 0; index1 < 3; ++index1) {
            ...
            for(int index2 = 0; index2 < 3; ++index2) {
               if ((0.0D != sx || 0.0D != sy || 0.0D != sz) && (world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz)).getBlock() == CrustyChunksModBlocks.DAMAGEDFUELTANK.get() || world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz)).getBlock() == CrustyChunksModBlocks.FUEL_TANK.get() || world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz)).getBlock() == CrustyChunksModBlocks.FUEL_TANK_MODULE.get())) {
                  ...
                  if (!((<undefinedtype>)(new Object() {
                     ...
                     if (((<undefinedtype>)(new Object() {
                        ...
                        })).getBlockTanks(world, BlockPos.containing(x, y, z))) > ((<undefinedtype>)(new Object() {
                           public int getFluidTankLevel(LevelAccessor level, BlockPos pos, int tank) {
                              AtomicInteger _retval = new AtomicInteger(0);
                              BlockEntity _ent = level.getBlockEntity(pos);
                              if (_ent != null) {
                        ...
                        })).getFluidTankLevel(world, BlockPos.containing(x + sx, y + sy, z + sz), ((<undefinedtype>)(new Object() {
                           public int getBlockTanks(LevelAccessor level, BlockPos pos) {
                              AtomicInteger _retval = new AtomicInteger(0);
                              BlockEntity _ent = level.getBlockEntity(pos);
                              if (_ent != null) {
