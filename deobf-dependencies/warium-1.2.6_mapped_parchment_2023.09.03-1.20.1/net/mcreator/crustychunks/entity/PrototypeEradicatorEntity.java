...
public class PrototypeEradicatorEntity extends Monster implements GeoEntity {
   ...
   public PrototypeEradicatorEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.PROTOTYPE_ERADICATOR.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "protoeradicator");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new AvoidEntityGoal(this, EradicatorEntity.class, 30.0F, 1.0D, 1.2D));
   ...
   public static Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 256.0D);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(PrototypeEradicatorEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(PrototypeEradicatorEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(PrototypeEradicatorEntity.class, EntityDataSerializers.STRING);
   }
}
