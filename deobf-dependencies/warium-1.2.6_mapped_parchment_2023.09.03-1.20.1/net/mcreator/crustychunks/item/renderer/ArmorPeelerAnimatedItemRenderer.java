...
public class ArmorPeelerAnimatedItemRenderer extends GeoItemRenderer<ArmorPeelerAnimatedItem> {
   ...
   public void renderRecursively(PoseStack stack, ArmorPeelerAnimatedItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
