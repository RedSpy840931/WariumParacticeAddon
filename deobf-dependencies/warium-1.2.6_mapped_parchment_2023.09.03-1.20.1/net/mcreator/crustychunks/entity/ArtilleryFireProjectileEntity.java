...
public class ArtilleryFireProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public ArtilleryFireProjectileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.ARTILLERY_FIRE_PROJECTILE.get(), world);
   }
   ...
   public static ArtilleryFireProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      ArtilleryFireProjectileEntity entityarrow = new ArtilleryFireProjectileEntity((EntityType)CrustyChunksModEntities.ARTILLERY_FIRE_PROJECTILE.get(), entity, world);
   ...
   public static ArtilleryFireProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      ArtilleryFireProjectileEntity entityarrow = new ArtilleryFireProjectileEntity((EntityType)CrustyChunksModEntities.ARTILLERY_FIRE_PROJECTILE.get(), entity, entity.level());
   ...
   static {
      PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.ARTILLERY_SHELL.get());
   }
}
