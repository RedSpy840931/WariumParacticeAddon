         ...
         if (var10000.getCount() == 0) {
            ...
            if (var10001.getOrCreateTag().getBoolean("Loaded")) {
               ...
               if (entity instanceof Player) {
                  ...
                  var17.addCooldown(var10001.getItem(), 40);
               }
            }
         } else {
            if (entity instanceof LivingEntity) {
            ...
            if (var10000.getItem() == CrustyChunksModItems.FLARE_CHARGE.get()) {
               ...
               if (!var10001.getOrCreateTag().getBoolean("Loaded")) {
                  ...
                  if (var10000.getItem() instanceof FlarePistolItem) {
                     if (entity instanceof LivingEntity) {
                        _livEnt = (LivingEntity)entity;
                        var10000 = _livEnt.getMainHandItem();
                     } else {
                     ...
                     var10000.getOrCreateTag().putString("geckoAnim", "load");
                  }

                  if (world instanceof Level) {
                     _level = (Level)world;
                     if (!_level.isClientSide()) {
                        _level.playSound((Player)null, BlockPos.containing(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:revolver")), SoundSource.NEUTRAL, 1.0F, 0.8F);
                     } else {
                        _level.playLocalSound(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:revolver")), SoundSource.NEUTRAL, 1.0F, 0.8F, false);
                     }
                  }
                  ...
                  if (entity instanceof Player) {
                     ...
                     var17.addCooldown(var10001.getItem(), 20);
                  }
