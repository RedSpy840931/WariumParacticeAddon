...
public class ClusterBombProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public ClusterBombProjectileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.CLUSTER_BOMB_PROJECTILE.get(), world);
   }
   ...
   public static ClusterBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      ClusterBombProjectileEntity entityarrow = new ClusterBombProjectileEntity((EntityType)CrustyChunksModEntities.CLUSTER_BOMB_PROJECTILE.get(), entity, world);
   ...
   public static ClusterBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      ClusterBombProjectileEntity entityarrow = new ClusterBombProjectileEntity((EntityType)CrustyChunksModEntities.CLUSTER_BOMB_PROJECTILE.get(), entity, entity.level());
