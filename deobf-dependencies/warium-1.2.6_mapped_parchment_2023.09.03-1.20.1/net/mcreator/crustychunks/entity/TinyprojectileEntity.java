...
public class TinyprojectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public TinyprojectileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.TINYPROJECTILE.get(), world);
   }
   ...
   public static TinyprojectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      TinyprojectileEntity entityarrow = new TinyprojectileEntity((EntityType)CrustyChunksModEntities.TINYPROJECTILE.get(), entity, world);
   ...
   public static TinyprojectileEntity shoot(LivingEntity entity, LivingEntity target) {
      TinyprojectileEntity entityarrow = new TinyprojectileEntity((EntityType)CrustyChunksModEntities.TINYPROJECTILE.get(), entity, entity.level());
