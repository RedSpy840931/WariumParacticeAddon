...
public class AutoPistolItemRenderer extends GeoItemRenderer<AutoPistolItem> {
   ...
   public void actuallyRender(PoseStack matrixStackIn, AutoPistolItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
   ...
   public void renderRecursively(PoseStack stack, AutoPistolItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
