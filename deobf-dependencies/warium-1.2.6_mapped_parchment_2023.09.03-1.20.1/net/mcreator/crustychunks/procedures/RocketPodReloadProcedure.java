   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         if (var10000.getItem() == CrustyChunksModItems.ARMOR_PEELER_ROCKET.get()) {
            if (9.0D > ((<undefinedtype>)(new Object() {
            ...
            if (var10000.getItem() == ItemStack.EMPTY.getItem() && 1.0D <= ((<undefinedtype>)(new Object() {
               ...
               if (world instanceof ServerLevel) {
                  ...
                  ItemEntity entityToSpawn = new ItemEntity(_level, x + 0.5D, y + 1.5D, z + 0.5D, new ItemStack((ItemLike)CrustyChunksModItems.ARMOR_PEELER_ROCKET.get()));
