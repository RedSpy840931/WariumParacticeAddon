...
public class DPToggleProcedure {
   public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments, Entity entity) {
      if (entity != null) {
         ...
         double Flamers = 0.0D;
         double Hunters = 0.0D;
         ((BooleanValue)world.getLevelData().getGameRules().getRule(CrustyChunksModGameRules.WARIUM_APOCALYPSE_DYNAMIC_PRODUCTION)).set(BoolArgumentType.getBool(arguments, "Toggle"), world.getServer());
         Player _player;
