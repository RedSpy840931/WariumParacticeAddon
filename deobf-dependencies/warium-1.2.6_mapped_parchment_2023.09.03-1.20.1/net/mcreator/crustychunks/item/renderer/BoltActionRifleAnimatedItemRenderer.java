...
public class BoltActionRifleAnimatedItemRenderer extends GeoItemRenderer<BoltActionRifleAnimatedItem> {
   ...
   public void renderRecursively(PoseStack stack, BoltActionRifleAnimatedItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
