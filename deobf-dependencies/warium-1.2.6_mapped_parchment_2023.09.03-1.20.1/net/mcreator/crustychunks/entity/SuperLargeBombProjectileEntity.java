...
public class SuperLargeBombProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public SuperLargeBombProjectileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.SUPER_LARGE_BOMB_PROJECTILE.get(), world);
   }
   ...
   public void onHitBlock(BlockHitResult blockHitResult) {
      ...
      SuperLargeBombProjectileHitsBlockProcedure.execute(this.level(), (double)blockHitResult.getBlockPos().getX(), (double)blockHitResult.getBlockPos().getY(), (double)blockHitResult.getBlockPos().getZ(), this);
   }
   ...
   public static SuperLargeBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      SuperLargeBombProjectileEntity entityarrow = new SuperLargeBombProjectileEntity((EntityType)CrustyChunksModEntities.SUPER_LARGE_BOMB_PROJECTILE.get(), entity, world);
   ...
   public static SuperLargeBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      SuperLargeBombProjectileEntity entityarrow = new SuperLargeBombProjectileEntity((EntityType)CrustyChunksModEntities.SUPER_LARGE_BOMB_PROJECTILE.get(), entity, entity.level());
   ...
   static {
      PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModBlocks.SMALL_BOMB.get());
   }
}
