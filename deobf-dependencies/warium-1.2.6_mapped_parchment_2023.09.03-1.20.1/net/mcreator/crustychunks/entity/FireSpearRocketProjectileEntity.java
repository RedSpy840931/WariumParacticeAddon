...
public class FireSpearRocketProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public FireSpearRocketProjectileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.FIRE_SPEAR_ROCKET_PROJECTILE.get(), world);
   }
   ...
   public static FireSpearRocketProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      FireSpearRocketProjectileEntity entityarrow = new FireSpearRocketProjectileEntity((EntityType)CrustyChunksModEntities.FIRE_SPEAR_ROCKET_PROJECTILE.get(), entity, world);
   ...
   public static FireSpearRocketProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      FireSpearRocketProjectileEntity entityarrow = new FireSpearRocketProjectileEntity((EntityType)CrustyChunksModEntities.FIRE_SPEAR_ROCKET_PROJECTILE.get(), entity, entity.level());
   ...
   static {
      PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.FIRE_SPEAR_ROCKET.get());
   }
}
