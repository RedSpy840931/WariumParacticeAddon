      ...
      if (entity != null) {
         ...
         if (var10000.getCount() == 0) {
            ...
            if (var10001.getOrCreateTag().getBoolean("Loaded")) {
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  _setstack = (new ItemStack((ItemLike)CrustyChunksModItems.MEDIUM_MAGAZINE.get())).copy();
               ...
               var19.putDouble("Ammo", var10002.getOrCreateTag().getDouble("Ammo"));
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
               ...
               var19.putString("Type", var10002.getOrCreateTag().getString("Type"));
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  var10000 = _livEnt.getMainHandItem();
               } else {
            ...
            if (var10000.getItem() == CrustyChunksModItems.MEDIUM_MAGAZINE.get()) {
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  var10001 = _livEnt.getMainHandItem();
               } else {
         ...
         if (var10001.getOrCreateTag().getBoolean("Loaded")) {
            ...
            if (var10000.getItem() == CrustyChunksModItems.MEDIUM_MAGAZINE.get() && entity instanceof Player) {
