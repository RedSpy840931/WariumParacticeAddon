...
public class ScopedBoltActionRifleAnimatedItemRenderer extends GeoItemRenderer<ScopedBoltActionRifleAnimatedItem> {
   ...
   public void renderRecursively(PoseStack stack, ScopedBoltActionRifleAnimatedItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
