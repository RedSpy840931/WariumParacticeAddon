...
public class GasArtilleryProjectileRenderer extends EntityRenderer<GasArtilleryProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/gasartillerytexture.png");
   ...
   public void render(GasArtilleryProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
