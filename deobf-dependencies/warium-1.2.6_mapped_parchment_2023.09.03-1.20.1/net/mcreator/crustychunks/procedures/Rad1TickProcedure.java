...
public class Rad1TickProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      while(var9.hasNext()) {
         ...
         if (5000.0D > entityiterator.getPersistentData().getDouble("Radiation")) {
            entityiterator.getPersistentData().putDouble("Radiation", entityiterator.getPersistentData().getDouble("Radiation") + 1.0D);
