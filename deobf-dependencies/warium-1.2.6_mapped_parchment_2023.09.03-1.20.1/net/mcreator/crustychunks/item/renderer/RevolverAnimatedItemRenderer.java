...
public class RevolverAnimatedItemRenderer extends GeoItemRenderer<RevolverAnimatedItem> {
   ...
   public void renderRecursively(PoseStack stack, RevolverAnimatedItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
