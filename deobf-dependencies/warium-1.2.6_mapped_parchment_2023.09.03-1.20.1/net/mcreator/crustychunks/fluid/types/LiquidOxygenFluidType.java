...
public class LiquidOxygenFluidType extends FluidType {
   ...
   public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
      consumer.accept(new IClientFluidTypeExtensions() {
         private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("crusty_chunks:block/liquidgas");
         private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("crusty_chunks:block/liquidgas");
