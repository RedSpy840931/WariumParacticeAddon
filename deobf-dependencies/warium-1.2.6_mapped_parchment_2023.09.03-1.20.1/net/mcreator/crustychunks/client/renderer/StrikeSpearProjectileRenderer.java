...
public class StrikeSpearProjectileRenderer extends EntityRenderer<StrikeSpearProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/strikespear.png");
   ...
   public void render(StrikeSpearProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
