...
public class WariumApocalypseToggleCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("WariumApocalypseMode").requires((s) -> {
         ...
         ApocalypseModeToggleProcedure.execute(world, arguments, (Entity)entity);
         return 0;
      })));
   }
}
