...
public class AutomaticRifleItemRenderer extends GeoItemRenderer<AutomaticRifleItem> {
   ...
   public void renderRecursively(PoseStack stack, AutomaticRifleItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
