...
import net.mcreator.crustychunks.procedures.CIWSAIProcedure;
...
public class CIWSEntity extends Monster implements GeoEntity {
   ...
   public CIWSEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.CIWS.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "ciws");
   }
   ...
   public void baseTick() {
      super.baseTick();
      CIWSAIProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(CIWSEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(CIWSEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(CIWSEntity.class, EntityDataSerializers.STRING);
   }
}
