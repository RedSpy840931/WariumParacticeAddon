...
public class ScopedBoltActionRifleAnimatedItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new ScopedBoltActionRifleAnimatedItemRenderer();
         private static final ArmPose ScopedBoltActionRifleAnimatedPose = ArmPose.create("ScopedBoltActionRifleAnimated", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? ScopedBoltActionRifleAnimatedPose : ArmPose.EMPTY;
         }
