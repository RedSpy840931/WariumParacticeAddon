...
public class CrusherGUIScreen extends AbstractContainerScreen<CrusherGUIMenu> {
   ...
   protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
      ...
      guiGraphics.blit(new ResourceLocation("crusty_chunks:textures/screens/graygear.png"), this.leftPos + 4, this.topPos + 4, 0.0F, 0.0F, 16, 16, 16, 16);
   ...
   static {
      guistate = CrusherGUIMenu.guistate;
      texture = new ResourceLocation("crusty_chunks:textures/screens/crusher_gui.png");
   }
}
