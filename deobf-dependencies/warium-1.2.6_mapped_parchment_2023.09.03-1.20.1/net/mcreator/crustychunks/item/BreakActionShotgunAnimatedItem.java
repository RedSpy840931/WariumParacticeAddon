...
public class BreakActionShotgunAnimatedItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new BreakActionShotgunAnimatedItemRenderer();
         private static final ArmPose BreakActionShotgunAnimatedPose = ArmPose.create("BreakActionShotgunAnimated", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? BreakActionShotgunAnimatedPose : ArmPose.EMPTY;
         }
