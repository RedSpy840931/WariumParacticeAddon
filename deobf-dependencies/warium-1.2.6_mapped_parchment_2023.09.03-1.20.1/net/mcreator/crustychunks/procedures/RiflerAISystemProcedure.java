      ...
      if (entity != null) {
         ...
         if (var10000 != null) {
            ...
            if (var10000.isAlive()) {
               ...
               double var19 = var10005.getY() + 1.0D;
               ...
               var10002.<init>(var18, var19, var10006.getZ());
               entity.lookAt(var10001, var10002);
               float var17;
               if (entity instanceof LivingEntity) {
                  LivingEntity _livEnt = (LivingEntity)entity;
                  var17 = _livEnt.getHealth();
               } else {
                  var17 = -1.0F;
               }
         ...
         if (entity.getPersistentData().getDouble("Cycle") > 0.0D) {
            ...
            if (world instanceof Level) {
               ...
               if (!_level.isClientSide()) {
                  _level.playSound((Player)null, BlockPos.containing(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:strikerstep")), SoundSource.NEUTRAL, 3.0F, (float)Mth.nextDouble(RandomSource.create(), 1.3D, 1.5D));
               } else {
                  _level.playLocalSound(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:strikerstep")), SoundSource.NEUTRAL, 3.0F, (float)Mth.nextDouble(RandomSource.create(), 1.3D, 1.5D), false);
               }
            }
         }
