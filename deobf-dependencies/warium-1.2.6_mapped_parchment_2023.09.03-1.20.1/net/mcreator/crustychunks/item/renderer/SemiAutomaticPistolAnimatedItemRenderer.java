...
public class SemiAutomaticPistolAnimatedItemRenderer extends GeoItemRenderer<SemiAutomaticPistolAnimatedItem> {
   ...
   public void renderRecursively(PoseStack stack, SemiAutomaticPistolAnimatedItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
