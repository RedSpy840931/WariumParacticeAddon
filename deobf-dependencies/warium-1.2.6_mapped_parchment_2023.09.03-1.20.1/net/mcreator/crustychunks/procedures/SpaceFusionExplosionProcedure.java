...
public class SpaceFusionExplosionProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      SpaceScorchProcedure.execute(world, x, y, z, 0.75D);
      SpacePlasmaCraterProcedure.execute(world, x, y, z, 0.75D);
      ...
      if (world instanceof ServerLevel) {
         ...
         Projectile _entityToSpawn = ((<undefinedtype>)(new Object() {
            public Projectile getArrow(Level level, float damage, int knockback) {
               AbstractArrow entityToSpawn = new SpaceFusionThermalRadEntityEntity((EntityType)CrustyChunksModEntities.SPACE_FUSION_THERMAL_RAD_ENTITY.get(), level);
