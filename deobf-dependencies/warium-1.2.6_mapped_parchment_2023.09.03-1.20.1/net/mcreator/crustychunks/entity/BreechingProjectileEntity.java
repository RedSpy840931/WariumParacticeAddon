...
public class BreechingProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public BreechingProjectileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.BREECHING_PROJECTILE.get(), world);
   }
   ...
   public void onHitBlock(BlockHitResult blockHitResult) {
      ...
      BreechingProjectileHitProcedure.execute(this.level(), (double)blockHitResult.getBlockPos().getX(), (double)blockHitResult.getBlockPos().getY(), (double)blockHitResult.getBlockPos().getZ());
   }
   ...
   public static BreechingProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      BreechingProjectileEntity entityarrow = new BreechingProjectileEntity((EntityType)CrustyChunksModEntities.BREECHING_PROJECTILE.get(), entity, world);
   ...
   public static BreechingProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      BreechingProjectileEntity entityarrow = new BreechingProjectileEntity((EntityType)CrustyChunksModEntities.BREECHING_PROJECTILE.get(), entity, entity.level());
