...
public class ScopedBreechRifleItemRenderer extends GeoItemRenderer<ScopedBreechRifleItem> {
   ...
   public void renderRecursively(PoseStack stack, ScopedBreechRifleItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
