...
public class GenericlargeBulletEntity extends AbstractArrow implements ItemSupplier {
   ...
   public GenericlargeBulletEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.GENERICLARGE_BULLET.get(), world);
   }
   ...
   public static GenericlargeBulletEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      GenericlargeBulletEntity entityarrow = new GenericlargeBulletEntity((EntityType)CrustyChunksModEntities.GENERICLARGE_BULLET.get(), entity, world);
   ...
   public static GenericlargeBulletEntity shoot(LivingEntity entity, LivingEntity target) {
      GenericlargeBulletEntity entityarrow = new GenericlargeBulletEntity((EntityType)CrustyChunksModEntities.GENERICLARGE_BULLET.get(), entity, entity.level());
