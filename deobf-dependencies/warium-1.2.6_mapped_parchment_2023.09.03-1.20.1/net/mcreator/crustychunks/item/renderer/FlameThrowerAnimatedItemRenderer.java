...
public class FlameThrowerAnimatedItemRenderer extends GeoItemRenderer<FlameThrowerAnimatedItem> {
   ...
   public void renderRecursively(PoseStack stack, FlameThrowerAnimatedItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
