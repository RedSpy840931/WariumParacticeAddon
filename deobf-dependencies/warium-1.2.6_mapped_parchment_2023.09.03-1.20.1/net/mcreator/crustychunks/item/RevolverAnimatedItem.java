...
public class RevolverAnimatedItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new RevolverAnimatedItemRenderer();
         private static final ArmPose RevolverAnimatedPose = ArmPose.create("RevolverAnimated", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? RevolverAnimatedPose : ArmPose.EMPTY;
         }
