...
public class SmallMuzzleFlashProducerEntity extends AbstractArrow implements ItemSupplier {
   ...
   public SmallMuzzleFlashProducerEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.SMALL_MUZZLE_FLASH_PRODUCER.get(), world);
   }
   ...
   public static SmallMuzzleFlashProducerEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      SmallMuzzleFlashProducerEntity entityarrow = new SmallMuzzleFlashProducerEntity((EntityType)CrustyChunksModEntities.SMALL_MUZZLE_FLASH_PRODUCER.get(), entity, world);
   ...
   public static SmallMuzzleFlashProducerEntity shoot(LivingEntity entity, LivingEntity target) {
      SmallMuzzleFlashProducerEntity entityarrow = new SmallMuzzleFlashProducerEntity((EntityType)CrustyChunksModEntities.SMALL_MUZZLE_FLASH_PRODUCER.get(), entity, entity.level());
