...
public class StealthPistolFireProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
      if (entity != null) {
         ...
         double recoil = 0.0D;
         if (((CrustyChunksModVariables.PlayerVariables)entity.getCapability(CrustyChunksModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CrustyChunksModVariables.PlayerVariables())).clickrelease) {
                  ...
                  if (itemstack.getOrCreateTag().getBoolean("Loaded")) {
                     ...
                     if (itemstack.getOrCreateTag().getString("Type").equals("AP")) {
                        ...
                        if (!projectileLevel.isClientSide()) {
                           ...
                           _entityToSpawn.shoot(entity.getLookAngle().x, entity.getLookAngle().y, entity.getLookAngle().z, 4.0F, (float)Movementinnacuracy);
