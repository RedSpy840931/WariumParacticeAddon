...
public class SemiAutomaticRifleAnimatedItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new SemiAutomaticRifleAnimatedItemRenderer();
         private static final ArmPose SemiAutomaticRifleAnimatedPose = ArmPose.create("SemiAutomaticRifleAnimated", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? SemiAutomaticRifleAnimatedPose : ArmPose.EMPTY;
         }
