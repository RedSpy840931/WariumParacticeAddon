      ...
      if (immediatesourceentity != null) {
         ...
         if (immediatesourceentity.getPersistentData().getDouble("T") >= 20.0D && world instanceof Level) {
            ...
            if (!_level.isClientSide()) {
               _level.playSound((Player)null, BlockPos.containing(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.firework_rocket.launch")), SoundSource.NEUTRAL, 3.0F, (float)(3.0D - immediatesourceentity.getLookAngle().y * 3.0D));
            } else {
               _level.playLocalSound(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.firework_rocket.launch")), SoundSource.NEUTRAL, 3.0F, (float)(3.0D - immediatesourceentity.getLookAngle().y * 3.0D), false);
            }
         }
