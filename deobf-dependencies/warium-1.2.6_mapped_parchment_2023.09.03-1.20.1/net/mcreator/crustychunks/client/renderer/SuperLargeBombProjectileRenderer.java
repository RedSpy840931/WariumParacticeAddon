...
public class SuperLargeBombProjectileRenderer extends EntityRenderer<SuperLargeBombProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/largebomb.png");
   ...
   public void render(SuperLargeBombProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
