      ...
      if (entity != null) {
         ...
         if (entity.isAlive()) {
            ...
            label327: {
               if (var10000 != null) {
                  ...
                  if (var10000.isAlive()) {
                     ...
                     if (Mth.nextInt(RandomSource.create(), 1, 5) == 1) {
                        ...
                        var10002.<init>(var39, var40, var10006.getZ());
                        entity.lookAt(var37, var10002);
                     }
                     ...
                     if (entity.getPersistentData().getDouble("T") <= 0.0D) {
                        ...
                        if (var10000.getY() > y + 30.0D) {
                           ...
                           double var41 = Math.pow(Math.abs(y - var38.getY()), 2.0D);
                           LivingEntity var36;
                           if (entity instanceof Mob) {
                              _mobEnt = (Mob)entity;
                           ...
                           var41 += Math.pow(Math.abs(z - var36.getZ()), 2.0D);
                           if (entity instanceof Mob) {
                              _mobEnt = (Mob)entity;
                              var36 = _mobEnt.getTarget();
                           } else {
                           ...
                           targetrange = Math.sqrt(var41 + Math.pow(Math.abs(x - var36.getX()), 2.0D));
                           ...
                           var39 += var10005.getDeltaMovement().x() * 1.25D * LeadRange * 0.09D;
                           var40 = y + 25.0D;
                           if (entity instanceof Mob) {
                              _mobEnt = (Mob)entity;
                              var10006 = _mobEnt.getTarget();
                           ...
                           double var42 = var10006.getY() + 3.0D;
                           ...
                           var40 = Math.max(var40, var42 + var10007.getDeltaMovement().y() * 1.25D * LeadRange * 0.09D);
                           if (entity instanceof Mob) {
                              _mobEnt = (Mob)entity;
                              var10006 = _mobEnt.getTarget();
                           } else {
                           ...
                           var10002.<init>(var39, var40, var42 + var10007.getDeltaMovement().z() * 1.25D * LeadRange * 0.09D);
                           entity.lookAt(var37, var10002);
               ...
               if (var35 < var10001 && 1 == Mth.nextInt(RandomSource.create(), 1, 15)) {
            ...
            if (entity.getPersistentData().getDouble("Cycle") > 0.0D) {
               ...
               if (entity.getDeltaMovement().x() != 0.0D && entity.getDeltaMovement().z() != 0.0D) {
                  if (entity instanceof EradicatorEntity && world instanceof Level) {
                     _level = (Level)world;
                     if (!_level.isClientSide()) {
                        _level.playSound((Player)null, BlockPos.containing(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:megamechstep")), SoundSource.NEUTRAL, 4.0F, (float)Mth.nextDouble(RandomSource.create(), 0.5D, 0.6D));
                     } else {
                        _level.playLocalSound(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:megamechstep")), SoundSource.NEUTRAL, 4.0F, (float)Mth.nextDouble(RandomSource.create(), 0.5D, 0.6D), false);
                     }
                  }

                  if (world instanceof ServerLevel) {
                     _level = (ServerLevel)world;
                     _level.sendParticles((SimpleParticleType)CrustyChunksModParticleTypes.DUST.get(), x, y + 0.5D, z, 14, 5.0D, 0.0D, 5.0D, 0.1D);
                  }
               ...
               if (world instanceof Level) {
                  _level = (Level)world;
                  if (!_level.isClientSide()) {
                     _level.playSound((Player)null, BlockPos.containing(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:turbine")), SoundSource.NEUTRAL, (float)(3.0D + rev), (float)(Mth.nextDouble(RandomSource.create(), 0.6D, 0.7D) + rev));
                  } else {
                     _level.playLocalSound(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:turbine")), SoundSource.NEUTRAL, (float)(3.0D + rev), (float)(Mth.nextDouble(RandomSource.create(), 0.6D, 0.7D) + rev), false);
                  }
               }
            ...
            if (var35 < var10001 / 2.0F && 10 == Mth.nextInt(RandomSource.create(), 1, 15)) {
            ...
            if (entity.isInWater()) {
               ...
               world.addParticle((SimpleParticleType)CrustyChunksModParticleTypes.SPLASH_PUFF.get(), x, y, z, 1.0D, -1.0D, 1.0D);
               world.addParticle((SimpleParticleType)CrustyChunksModParticleTypes.SPLASH_PUFF.get(), x, y, z, -1.0D, -1.0D, -1.0D);
               world.addParticle((SimpleParticleType)CrustyChunksModParticleTypes.SPLASH_PUFF.get(), x, y, z, -1.0D, -1.0D, 1.0D);
               world.addParticle((SimpleParticleType)CrustyChunksModParticleTypes.SPLASH_PUFF.get(), x, y, z, 1.0D, -1.0D, -1.0D);
