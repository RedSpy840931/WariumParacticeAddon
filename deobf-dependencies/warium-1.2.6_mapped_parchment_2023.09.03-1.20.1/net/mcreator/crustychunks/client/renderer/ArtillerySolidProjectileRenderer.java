...
public class ArtillerySolidProjectileRenderer extends EntityRenderer<ArtillerySolidProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/solidshell.png");
   ...
   public void render(ArtillerySolidProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
