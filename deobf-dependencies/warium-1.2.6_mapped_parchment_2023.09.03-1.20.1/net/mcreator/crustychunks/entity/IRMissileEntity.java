...
public class IRMissileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public IRMissileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.IR_MISSILE.get(), world);
   }
   ...
   public static IRMissileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      IRMissileEntity entityarrow = new IRMissileEntity((EntityType)CrustyChunksModEntities.IR_MISSILE.get(), entity, world);
   ...
   public static IRMissileEntity shoot(LivingEntity entity, LivingEntity target) {
      IRMissileEntity entityarrow = new IRMissileEntity((EntityType)CrustyChunksModEntities.IR_MISSILE.get(), entity, entity.level());
