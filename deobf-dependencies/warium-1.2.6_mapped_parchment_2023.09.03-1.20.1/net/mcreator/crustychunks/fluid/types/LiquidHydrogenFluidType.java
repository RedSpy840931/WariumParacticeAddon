...
public class LiquidHydrogenFluidType extends FluidType {
   ...
   public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
      consumer.accept(new IClientFluidTypeExtensions() {
         private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("crusty_chunks:block/clearblock");
         private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("crusty_chunks:block/clearblock");
