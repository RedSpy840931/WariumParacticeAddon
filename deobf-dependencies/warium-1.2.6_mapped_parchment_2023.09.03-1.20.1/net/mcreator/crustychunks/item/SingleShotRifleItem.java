...
public class SingleShotRifleItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new SingleShotRifleItemRenderer();
         private static final ArmPose SingleShotRiflePose = ArmPose.create("SingleShotRifle", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? SingleShotRiflePose : ArmPose.EMPTY;
         }
