...
public class EradicatorEntity extends Monster implements GeoEntity {
   ...
   public EradicatorEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.ERADICATOR.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "eradicator");
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(EradicatorEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(EradicatorEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(EradicatorEntity.class, EntityDataSerializers.STRING);
   }
}
