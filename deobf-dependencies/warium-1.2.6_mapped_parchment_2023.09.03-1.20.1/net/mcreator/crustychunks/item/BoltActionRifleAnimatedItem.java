...
public class BoltActionRifleAnimatedItem extends Item implements GeoItem {
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         private final BlockEntityWithoutLevelRenderer renderer = new BoltActionRifleAnimatedItemRenderer();
         private static final ArmPose BoltActionRifleAnimatedPose = ArmPose.create("BoltActionRifleAnimated", false, (model, entity, arm) -> {
         ...
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
            return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? BoltActionRifleAnimatedPose : ArmPose.EMPTY;
         }
