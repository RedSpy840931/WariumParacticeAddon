         ...
         if (var10000.getCount() == 0) {
            ...
            if (var10001.getOrCreateTag().getBoolean("Loaded")) {
               ...
               if (0.0D == var10001.getOrCreateTag().getDouble("AmmoType")) {
                  if (world instanceof ServerLevel) {
                     ...
                     entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack((ItemLike)CrustyChunksModItems.HUGE_BULLET.get()));
                  ...
                  if (1.0D == var10001.getOrCreateTag().getDouble("AmmoType") && world instanceof ServerLevel) {
                     _level = (ServerLevel)world;
                     entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack((ItemLike)CrustyChunksModItems.HUGE_HE_BULLET.get()));
                     entityToSpawn.setPickUpDelay(10);
                     _level.addFreshEntity(entityToSpawn);
                  }
               }
            ...
            if (var10000.getItem() == CrustyChunksModItems.HUGE_BULLET.get()) {
               ...
               if (!var10001.getOrCreateTag().getBoolean("Loaded")) {
                  ...
                  if (var10000.getItem() instanceof SingleShotRifleItem) {
                     if (entity instanceof LivingEntity) {
                        _livEnt = (LivingEntity)entity;
                        var10000 = _livEnt.getMainHandItem();
                     } else {
                  ...
                  if (entity instanceof Player) {
                     ...
                     var18.addCooldown(var10001.getItem(), 60);
                  }
