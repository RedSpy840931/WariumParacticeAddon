...
public class SeekerSpearMissileProjectileRenderer extends EntityRenderer<SeekerSpearMissileProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/seekerspear.png");
   ...
   public void render(SeekerSpearMissileProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
