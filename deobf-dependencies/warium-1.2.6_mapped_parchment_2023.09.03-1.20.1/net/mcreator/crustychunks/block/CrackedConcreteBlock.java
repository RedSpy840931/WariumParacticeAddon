...
public class CrackedConcreteBlock extends Block {
   public CrackedConcreteBlock() {
      super(Properties.of().instrument(NoteBlockInstrument.BASEDRUM).mapColor(MapColor.CLAY).sound(new ForgeSoundType(1.0F, 1.0F, () -> {
         ...
         return (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.basalt.place"));
      }, () -> {
