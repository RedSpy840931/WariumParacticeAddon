...
public class SemiAutomaticRifleAnimatedItemRenderer extends GeoItemRenderer<SemiAutomaticRifleAnimatedItem> {
   ...
   public void renderRecursively(PoseStack stack, SemiAutomaticRifleAnimatedItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
