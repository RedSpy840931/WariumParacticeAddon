      ...
      if (entity != null) {
         ...
         if (var10000.getCount() == 0) {
            ...
            if (var10001.getOrCreateTag().getBoolean("Loaded")) {
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  _setstack = (new ItemStack((ItemLike)CrustyChunksModItems.LARGE_MAGAZINE.get())).copy();
            ...
            if (var10000.getItem() == CrustyChunksModItems.LARGE_MAGAZINE.get()) {
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  var10001 = _livEnt.getMainHandItem();
               } else {
         ...
         if (var10001.getOrCreateTag().getBoolean("Loaded")) {
            ...
            if (var10000.getItem() == CrustyChunksModItems.LARGE_MAGAZINE.get() && entity instanceof Player) {
