...
import net.mcreator.crustychunks.procedures.MortarerAIProcedure;
...
public class MortarerEntity extends Monster implements GeoEntity {
   ...
   public MortarerEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.MORTARER.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "mortarer");
   }
   ...
   public void baseTick() {
      super.baseTick();
      MortarerAIProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   static {
      SHOOT = SynchedEntityData.defineId(MortarerEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(MortarerEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(MortarerEntity.class, EntityDataSerializers.STRING);
   }
}
