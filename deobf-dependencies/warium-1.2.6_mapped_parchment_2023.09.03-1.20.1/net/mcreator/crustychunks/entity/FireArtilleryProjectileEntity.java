...
public class FireArtilleryProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public FireArtilleryProjectileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.FIRE_ARTILLERY_PROJECTILE.get(), world);
   }
   ...
   public static FireArtilleryProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      FireArtilleryProjectileEntity entityarrow = new FireArtilleryProjectileEntity((EntityType)CrustyChunksModEntities.FIRE_ARTILLERY_PROJECTILE.get(), entity, world);
   ...
   public static FireArtilleryProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      FireArtilleryProjectileEntity entityarrow = new FireArtilleryProjectileEntity((EntityType)CrustyChunksModEntities.FIRE_ARTILLERY_PROJECTILE.get(), entity, entity.level());
   ...
   static {
      PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.FIRE_ARTILLERY_SHELL.get());
   }
}
