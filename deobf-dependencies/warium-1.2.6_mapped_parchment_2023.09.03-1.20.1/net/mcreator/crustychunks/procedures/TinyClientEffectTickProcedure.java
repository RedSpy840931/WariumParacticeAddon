      ...
      if (immediatesourceentity != null) {
         ...
         if (!immediatesourceentity.getPersistentData().getBoolean("Used")) {
            for(int index0 = 0; index0 < 15; ++index0) {
               world.addParticle((SimpleParticleType)CrustyChunksModParticleTypes.SMOKE.get(), x, y, z, Mth.nextDouble(RandomSource.create(), -0.6D, 0.6D), Mth.nextDouble(RandomSource.create(), -1.0D, 0.5D), Mth.nextDouble(RandomSource.create(), -0.6D, 0.6D));
            }
