...
public class EnergyDisplayScreen extends AbstractContainerScreen<EnergyDisplayMenu> {
   ...
   protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
      ...
      guiGraphics.blit(new ResourceLocation("crusty_chunks:textures/screens/bigenergymeter.png"), this.leftPos + 4, this.topPos + 4, 0.0F, (float)Mth.clamp((int)ReturnPowerSpriteProcedure.execute(this.world, (double)this.x, (double)this.y, (double)this.z) * 16, 0, 464), 64, 16, 64, 480);
   ...
   static {
      guistate = EnergyDisplayMenu.guistate;
      texture = new ResourceLocation("crusty_chunks:textures/screens/energy_display.png");
   }
}
