...
public class BreakActionShotgunAnimatedItemRenderer extends GeoItemRenderer<BreakActionShotgunAnimatedItem> {
   ...
   public void renderRecursively(PoseStack stack, BreakActionShotgunAnimatedItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
