...
public class DecimatorEntity extends Monster implements GeoEntity {
   ...
   public DecimatorEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.DECIMATOR.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "steelgolem");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new AvoidEntityGoal(this, DecimatorEntity.class, 30.0F, 1.0D, 1.2D));
   ...
   static {
      SHOOT = SynchedEntityData.defineId(DecimatorEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(DecimatorEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(DecimatorEntity.class, EntityDataSerializers.STRING);
   }
}
