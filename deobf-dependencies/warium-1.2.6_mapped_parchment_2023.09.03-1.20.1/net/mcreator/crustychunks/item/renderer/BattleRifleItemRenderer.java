...
public class BattleRifleItemRenderer extends GeoItemRenderer<BattleRifleItem> {
   ...
   public void actuallyRender(PoseStack matrixStackIn, BattleRifleItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
   ...
   public void renderRecursively(PoseStack stack, BattleRifleItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
