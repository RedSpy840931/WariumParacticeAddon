...
public class LargeHEATFireEntity extends AbstractArrow implements ItemSupplier {
   ...
   public LargeHEATFireEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.LARGE_HEAT_FIRE.get(), world);
   }
   ...
   public static LargeHEATFireEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      LargeHEATFireEntity entityarrow = new LargeHEATFireEntity((EntityType)CrustyChunksModEntities.LARGE_HEAT_FIRE.get(), entity, world);
   ...
   public static LargeHEATFireEntity shoot(LivingEntity entity, LivingEntity target) {
      LargeHEATFireEntity entityarrow = new LargeHEATFireEntity((EntityType)CrustyChunksModEntities.LARGE_HEAT_FIRE.get(), entity, entity.level());
   ...
   static {
      PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.HEAT_PROJECTILE.get());
   }
}
