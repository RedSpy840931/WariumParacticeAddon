...
public class SingleShotRifleItemRenderer extends GeoItemRenderer<SingleShotRifleItem> {
   ...
   public void renderRecursively(PoseStack stack, SingleShotRifleItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
