...
public class MediumAIBulletEntity extends AbstractArrow implements ItemSupplier {
   ...
   public MediumAIBulletEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.MEDIUM_AI_BULLET.get(), world);
   }
   ...
   public static MediumAIBulletEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      MediumAIBulletEntity entityarrow = new MediumAIBulletEntity((EntityType)CrustyChunksModEntities.MEDIUM_AI_BULLET.get(), entity, world);
   ...
   public static MediumAIBulletEntity shoot(LivingEntity entity, LivingEntity target) {
      MediumAIBulletEntity entityarrow = new MediumAIBulletEntity((EntityType)CrustyChunksModEntities.MEDIUM_AI_BULLET.get(), entity, entity.level());
