...
public class LargeRadarMissileFlightProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         immediatesourceentity.getPersistentData().putDouble("MaxTime", 140.0D);
         Vec3 _center;
         if (immediatesourceentity.getPersistentData().getDouble("Time") <= 140.0D) {
         ...
         if (immediatesourceentity.getPersistentData().getDouble("Time") >= 10.0D && speed > 10.0D) {
