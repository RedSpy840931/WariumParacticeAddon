...
public class MachineCarbineItemRenderer extends GeoItemRenderer<MachineCarbineItem> {
   ...
   public void renderRecursively(PoseStack stack, MachineCarbineItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
