...
public class FireArtilleryProjectileRenderer extends EntityRenderer<FireArtilleryProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/fireartillerytexture.png");
   ...
   public void render(FireArtilleryProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
