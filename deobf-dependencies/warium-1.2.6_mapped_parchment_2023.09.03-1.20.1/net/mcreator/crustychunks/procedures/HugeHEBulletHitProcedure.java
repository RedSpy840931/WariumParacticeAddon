      ...
      if (immediatesourceentity != null) {
         ...
         for(int index0 = 0; index0 < 10; ++index0) {
            if (world instanceof ServerLevel) {
               ...
               _entityToSpawn.shoot(immediatesourceentity.getDeltaMovement().x(), immediatesourceentity.getDeltaMovement().y(), immediatesourceentity.getDeltaMovement().z(), 5.0F, 20.0F);
