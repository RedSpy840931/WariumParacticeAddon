...
public class MediumBombProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public MediumBombProjectileEntity(SpawnEntity packet, Level world) {
      super((EntityType)CrustyChunksModEntities.MEDIUM_BOMB_PROJECTILE.get(), world);
   }
   ...
   public static MediumBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      MediumBombProjectileEntity entityarrow = new MediumBombProjectileEntity((EntityType)CrustyChunksModEntities.MEDIUM_BOMB_PROJECTILE.get(), entity, world);
   ...
   public static MediumBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      MediumBombProjectileEntity entityarrow = new MediumBombProjectileEntity((EntityType)CrustyChunksModEntities.MEDIUM_BOMB_PROJECTILE.get(), entity, entity.level());
   ...
   static {
      PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModBlocks.REDSTONE_TNT.get());
   }
}
