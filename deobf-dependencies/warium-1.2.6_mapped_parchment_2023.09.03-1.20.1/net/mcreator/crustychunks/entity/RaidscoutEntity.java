...
public class RaidscoutEntity extends Monster implements GeoEntity {
   ...
   public RaidscoutEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.RAIDSCOUT.get(), world);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(TEXTURE, "scout");
   }
   ...
   public static void init() {
      SpawnPlacements.register((EntityType)CrustyChunksModEntities.RAIDSCOUT.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
         int x = pos.getX();
         int y = pos.getY();
         int z = pos.getZ();
   ...
   static {
      SHOOT = SynchedEntityData.defineId(RaidscoutEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(RaidscoutEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(RaidscoutEntity.class, EntityDataSerializers.STRING);
   }
}
