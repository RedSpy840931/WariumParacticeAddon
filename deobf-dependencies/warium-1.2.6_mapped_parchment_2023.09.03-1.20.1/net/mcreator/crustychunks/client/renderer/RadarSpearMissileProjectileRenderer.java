...
public class RadarSpearMissileProjectileRenderer extends EntityRenderer<RadarSpearMissileProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/radarspear.png");
   ...
   public void render(RadarSpearMissileProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
