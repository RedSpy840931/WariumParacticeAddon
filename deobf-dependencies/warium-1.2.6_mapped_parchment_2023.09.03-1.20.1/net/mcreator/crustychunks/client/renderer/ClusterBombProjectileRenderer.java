...
public class ClusterBombProjectileRenderer extends EntityRenderer<ClusterBombProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/clusterbomb.png");
   ...
   public void render(ClusterBombProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
