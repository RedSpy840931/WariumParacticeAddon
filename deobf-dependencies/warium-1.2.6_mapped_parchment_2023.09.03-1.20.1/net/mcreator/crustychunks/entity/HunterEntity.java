...
public class HunterEntity extends Monster implements GeoEntity {
   ...
   public HunterEntity(SpawnEntity packet, Level world) {
      this((EntityType)CrustyChunksModEntities.HUNTER.get(), world);
   }
   ...
   public EntityDimensions getDimensions(Pose p_33597_) {
      return super.getDimensions(p_33597_).scale(1.25F);
   }
   ...
   public static Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MOVEMENT_SPEED, 1.0D);
      builder = builder.add(Attributes.MAX_HEALTH, 25.0D);
      builder = builder.add(Attributes.ARMOR, 0.0D);
      builder = builder.add(Attributes.ATTACK_DAMAGE, 3.0D);
      builder = builder.add(Attributes.FOLLOW_RANGE, 32.0D);
      builder = builder.add(Attributes.FLYING_SPEED, 1.0D);
      return builder;
   }
   ...
   static {
      SHOOT = SynchedEntityData.defineId(HunterEntity.class, EntityDataSerializers.BOOLEAN);
      ANIMATION = SynchedEntityData.defineId(HunterEntity.class, EntityDataSerializers.STRING);
      TEXTURE = SynchedEntityData.defineId(HunterEntity.class, EntityDataSerializers.STRING);
   }
}
