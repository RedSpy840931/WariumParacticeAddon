      ...
      if (immediatesourceentity != null) {
         ...
         if (immediatesourceentity.getPersistentData().getDouble("T") >= 20.0D && world instanceof Level) {
            ...
            if (!_level.isClientSide()) {
               ...
               SoundEvent var10003 = (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("intentionally_empty"));
               ...
               SoundEvent var12 = (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("intentionally_empty"));
